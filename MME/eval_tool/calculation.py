...
parser.add_argument('--results_dir', default='/root/autodl-tmp/LLaVA/playground/data/eval/MME/eval_tool/answers/llava-v1.5-7b', type=str)
    ...
    def process_result(self, results_dir):
        ...
        for eval_type, task_name_list in eval_type_dict.items():
            ...
            for task_name in task_name_list:
                ...
                chunk_lines = list(self.divide_chunks(lines,n=2)) # one image corresponds to two questions
                ...
                for img_items in chunk_lines:
                    if len(img_items) != 2:
                        print(f"[WARNING] Skipping incomplete item group: {img_items}")
                        continue
